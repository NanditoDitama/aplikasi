...
public class RegisterActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                            ...
                            user.updateProfile(profileUpdates)
                                    .addOnCompleteListener(profileTask -> {
                                        ...
                                        if (profileTask.isSuccessful()) {
                                            ...
                                            Toast.makeText(RegisterActivity.this, "Gagal memperbarui profil: " + profileTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    } else {
                        ...
                        try {
                            ...
                            errorMessage = "Registrasi gagal: " + e.getMessage();
                        }
    ...
    private void saveUserToFirestore(FirebaseUser user, String name, String email) {
        ...
        userData.put("isAdmin", "false"); // default user biasa
