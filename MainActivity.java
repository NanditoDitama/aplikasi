...
public class MainActivity extends AppCompatActivity {
        ...
        if (user != null) {
            db.collection("users").document(user.getUid())
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            ...
                            if ("true".equals(isAdmin)) {
                                // User adalah admin, arahkan ke AdminActivity
                                startActivity(new Intent(MainActivity.this, AdminActivity.class));
                                finish();
                            } else {
                                // User biasa, lanjutkan dengan MainActivity
                                initializeViews();
                                setupListeners();
                                fetchUserData(user);
                                fetchReports();
                            ...
                            // Dokumen user tidak ditemukan, anggap sebagai user biasa
                            initializeViews();
                            setupListeners();
                            fetchUserData(user);
                            fetchReports();
                    ...
                    .addOnFailureListener(e -> {
                        ...
                        // Jika gagal, anggap sebagai user biasa
                        initializeViews();
                        setupListeners();
                        fetchUserData(user);
                        fetchReports();
    ...
    private void initializeViews() {
        ...
        adapter = new ReportAdapter(this, reportsList, false); // false karena ini bukan admin view
